          ...
          <div className="flex items-center mb-4 md:mb-0 justify-between w-full md:w-auto">
            <Link href="/">
              <div className="flex items-center cursor-pointer">
                <div className="h-12 w-12 bg-white rounded-full flex items-center justify-center mr-3 hidden md:flex">
                  <span className="text-primary font-bold text-lg">GEI</span>
                </div>
